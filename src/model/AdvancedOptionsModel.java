...
public class AdvancedOptionsModel extends BasicOptionsModel {
    ...
    private static final List<LineThickness> INITIAL_LINE_THICKNESSES =
            Arrays.asList(LineThickness.SMALL,
    ...
    private ListProperty<LineThickness> myLineThicknessOptionsProperty =
            new SimpleListProperty<>(FXCollections.observableArrayList());
    private ListProperty<LineType> myLineTypeOptions =
            new SimpleListProperty<>(FXCollections.observableArrayList());
